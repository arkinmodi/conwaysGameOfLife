...
main: CXXFLAGS += $(foreach includedir,$(prog_INCLUDE_DIRS),-I$(includedir))
main: LDFLAGS += $(foreach librarydir,$(prog_LIBRARY_DIRS),-L$(librarydir))
main: LDFLAGS += $(foreach library,$(prog_LIBRARIES),-l$(library))
...
lint:
	cpplint --filter=+readability/*,+whitespace/*,-legal/copyright,-build/header_guard,-runtime/int src/*.cpp src/*.h
